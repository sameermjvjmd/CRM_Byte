...
namespace CRM.Api.Data.Migrations
{
    ...
    [Migration("20260123192930_Week4_ContactRelationshipsAndReminders")]
    partial class Week4_ContactRelationshipsAndReminders
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRM.Api.Models.ContactRelationship", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CRM.Api.Models.ContactReminder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CRM.Api.Models.Marketing.LeadAssignmentRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CRM.Api.Models.Search.FilterPreset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CRM.Api.Models.Search.SavedSearch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SearchSavedSearches");
                });

            modelBuilder.Entity("CRM.Api.Models.Search.SearchHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CRM.Api.Models.SecondaryContact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CRM.Api.Models.ContactRelationship", b =>
                {
                    ...
                    b.HasOne("CRM.Api.Models.Contact", "RelatedContact")
                        .WithMany()
            ...
            modelBuilder.Entity("CRM.Api.Models.Document", b =>
                {
                    ...
                    b.HasOne("CRM.Api.Models.Document", "ParentDocument")
                        .WithMany("Versions")
