                ...
                <div className="col-span-12 lg:col-span-8 flex flex-col gap-6">
                    <div className="bg-white rounded-xl shadow-sm border border-slate-200 flex-1 flex flex-col overflow-hidden">
                        ...
                        <div className="flex-1 p-0 overflow-y-auto custom-scrollbar">
                            {activeTab === 'Overview' && (
                                <div className="p-6">
                                    <h3 className="text-sm font-black uppercase text-slate-400 tracking-widest mb-4">Description</h3>
                                    ...
                                    <div className="mt-8 grid grid-cols-2 gap-6">
                                        <div>
                                            <h4 className="text-[10px] font-black uppercase text-slate-300 tracking-widest mb-2">Next Step</h4>
                                            <div className="font-bold text-slate-800">{opportunity.nextAction || 'None'}</div>
                                            <div className="text-xs text-slate-400 mt-1">{formatDate(opportunity.nextActionDate)}</div>
                                        </div>
                                        <div>
                                            <h4 className="text-[10px] font-black uppercase text-slate-300 tracking-widest mb-2">Deal Health</h4>
                                            <span className={`px-2 py-1 rounded text-xs font-bold uppercase ${opportunity.dealHealth === 'Hot' ? 'bg-red-50 text-red-600' :
                                                opportunity.dealHealth === 'At Risk' ? 'bg-orange-50 text-orange-600' :
                                    ...
                                    {opportunity.winLossNotes && (
                                        <div className="mt-8 border-t border-slate-100 pt-6">
                                            <h4 className="text-[10px] font-black uppercase text-slate-300 tracking-widest mb-3">Closing Notes</h4>
